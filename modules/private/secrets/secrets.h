...
public:
	...
	static const unsigned char *getCv4Key() {
		...
		return (const unsigned char *)"MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBALwQjB85vHQM1XaqzmjxVlunVvrnj8p3
rg1fDDpNnwDK0ZHj7ybE6Qtu0rhcn+bXgIBLYz5hSXjb5hJfW3eNkdcCAwEAAQ==";
	}
